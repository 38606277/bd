...
@RestController
@RequestMapping("/reportServer/hbaseMetadataV2")
public class HbaseMetadataV2 extends RO
{
    private static final Logger log = Logger.getLogger(HbaseMetadataV2.class);
...
/*    // 删除数据库表
    ...
    public @ResponseBody
    String getDatabaseList(@RequestBody JSONObject pJson) {
...
//        statement.close();
    ...
    public @ResponseBody
    String synchronizeHbaseMetadata(@RequestBody JSONObject pJson) {
        List<Map<String, Object>> list = new ArrayList<>();
        try{
            String jdbcurl = pJson.getString("jdbcurl");
            String username = pJson.getString("username");
    ...
    public @ResponseBody
    String synchronizeHbaseMetadataV2(@RequestBody JSONObject pJson) {
        List<Map<String, Object>> list = new ArrayList<>();
        try{
            String jdbcurl = pJson.getString("jdbcurl");
            String username = pJson.getString("username");
...
//            System.out.println(res.getString(1)+"\t"+res.getString(2));
    ...
    @RequestMapping(value="/getHbaseDataBytableNameTest",produces = "text/plain;charset=UTF-8")
    public String getHbaseDataBytableNameTest(@RequestBody JSONObject pJson) throws UnsupportedEncodingException {
        String tableName = pJson.getString("tableName");

        Map<String,String> map = new HashMap<String,String>();
        map.put("tableName", tableName);
        List<Map> authList = DbFactory.Open("hbase_fu").selectList("hbasemetadata.getHbaseDataBytableNameTest",map);
        return JSON.toJSONString(authList);
    }



    public DruidDataSource getDataSource(JSONObject dbJson) throws IOException {
...
//            properties.setProperty("principal", principal);
    ...
    @RequestMapping(value="/getHbaseDataBytableNameDataSource",produces = "text/plain;charset=UTF-8")
    public String getHbaseDataBytableNameDataSource(@RequestBody JSONObject pJson) throws UnsupportedEncodingException {
        String tableName = pJson.getString("tableName");

        Map<String,String> map = new HashMap<String,String>();
        map.put("tableName", tableName);
        List<Map> authList = DbFactory.Open("hbase2").selectList("hbasemetadata.getHbaseDataBytableNameDataSource",map);
        return JSON.toJSONString(authList);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String password="admin";
         ...
         HbaseMetadataV2 hbaseMetadata = new HbaseMetadataV2();
        //DruidDataSource dataSource =  hbaseMetadata.getDataSource("");
